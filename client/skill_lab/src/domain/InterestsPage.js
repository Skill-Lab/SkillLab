   ...
   const handleFormat = (event, newFormats) => {
    ...
    return (
      ...
      <Grid container spacing={8} >
        <Grid item xs={12}>
          <ToggleButtonGroup className={classes.toggleButton} value={formats} onChange={handleFormat}>
        ...
        <div className={classes.toggleContainer}>
          <ToggleButtonGroup value={formats} onChange={handleFormat}>
            ...
            <ToggleButton value="interviews" className={classes.buttonColor}>
                Interviews
            </ToggleButton>
            <ToggleButton value="studying" className={classes.buttonColor}>
                Studying
            </ToggleButton>
            <ToggleButton value="networking" className={classes.buttonColor}>
                Networking
            </ToggleButton>
